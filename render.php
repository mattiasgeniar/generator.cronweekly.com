...
if ($_POST['type'] == 'html') {
  ...
  $h2 = "font-family: Helvetica; font-size: 20px; line-height: 1.1; display: block; margin-top: 16px; margin-bottom: 16px";
...
<head><meta charset="utf-8"><!-- utf-8 works for most cases -->
  ...
  <!-- The title tag shows in email notifications, like Android 4.4. --><!-- Web Font / @font-face : BEGIN --><!-- NOTE: If web fonts are not required, lines 9 - 26 can be safely removed. --><!-- Desktop Outlook chokes on web font references and defaults to Times New Roman, so we force a safe fallback font. --><!--[if mso]>
    ...
    <![endif]--><!-- All other clients get the webfont reference; some will render the font and others will silently fail to the fallbacks.  --><!--[if !mso]><!--><!-- insert web font reference, eg: <link href='https://fonts.googleapis.com/css?family=Roboto:400,700' rel='stylesheet' type='text/css'> --><!--<![endif]--><!-- Web Font / @font-face : END --><!-- CSS Reset -->
  <style type="text/css">
...
____ ____   ___  _   ___        _______ _____ _  ___  __   __
/ ___|  _ \ / _ \| \ | \ \      / / ____| ____| |/ / | \ \ / /
| |   | |_) | | | |  \| |\ \ /\ / /|  _| |  _| | ' /| |  \ V /
| |___|  _ <| |_| | |\  |_\ V  V / | |___| |___| . \| |___| |
\____|_| \_\\___/|_| \_(_)\_/\_/  |_____|_____|_|\_\_____|_|
